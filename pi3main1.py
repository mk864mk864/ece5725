...
while syson:
	...
	while going:
		...
		if playing:
			# subprocess calling to play, because Windows won't
			#let pygame.mixer and pygame.midi play at the same time.
			#This also limited the functionality to just play the recorded
			#audio once, since there is no good way to share the 
			#state of the pygame mixer of subprocess.
		...
		if i.poll():
			...
			#Check for velocity of the note to see if the note is
			#turning on or off.
